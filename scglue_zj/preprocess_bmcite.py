...
def my_app(cfg: DictConfig) -> None:
    ...
    with console.status("[bold green]Loading data..."):
        ...
        rna = sc.read("/mnt/sdbd/home/zhoujin_gyj/GLUE/data/GSE128639/RNA-2.8.h5ad")

        # Load the original ADT data.
        adt = sc.read("/mnt/sdbd/home/zhoujin_gyj/GLUE/data/GSE128639/Protein-2.8.h5ad")

        # Rename annotation
        rna.obs["celltype"] = rna.obs["cell_type"]
        adt.obs["celltype"] = rna.obs["cell_type"]
